...
def apply_model(oriImg, model, multiplier,numPoints):
	stride = 8
...
def main():
    ...
    modelsList = ['../saveparameter/blouse/15000.pth.tar','../saveparameter/dress/15000.pth.tar','../saveparameter/outwear/15000.pth.tar','../saveparameter/skirt/15000.pth.tar','../saveparameter/trousers/15000.pth.tar']
    ...
    for i in range(2,5):
        ...
        for j in range(num_imgs):
            ...
            keypoints = apply_model(oriImg, model, multiplier,numPoints)
    ...
    result_all.to_csv(("../submit/submit_"+datetime.datetime.now().strftime('%Y%m%d_%H%M%S') + ".csv"),index=None)
